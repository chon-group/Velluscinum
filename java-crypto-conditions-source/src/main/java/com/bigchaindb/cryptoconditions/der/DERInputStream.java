...
public class DERInputStream extends java.io.FilterInputStream
{
  ...
  public DERObject readTaggedConstructedObject(int expectedTagNumber, int limit, AtomicInteger bytesRead) throws IOException, DEREncodingException
  {
    ...
    {
      throw new DEREncodingException("Expected tag: " + DERTags.TAGGED.getTag() + DERTags.CONSTRUCTED.getTag() + expectedTagNumber + " but got: " + object.getTag());
    }
  ...
  public DERObject readTaggedObject(int expectedTagNumber, int limit, AtomicInteger bytesRead) throws IOException, DEREncodingException
  {
    ...
    {
      throw new DEREncodingException("Expected tag: " + Integer.toHexString(DERTags.TAGGED.getTag() + expectedTagNumber) + " but got: " + Integer.toHexString(object.getTag()));
    }
    return object;
  }
    ...
    throws IOException, DEREncodingException
  {
    ...
    obj.setTag(readTag(innerBytesRead, new DERTags[0]));
